...
!  "$URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/release_tags/cesm1_2_x_n00_share3_130528/shr/shr_orb_mod.F90 $"
...
!    write(s_logunit,F00) svnURL
   ...
   IF ( iyear_AD == SHR_ORB_UNDEF_INT .or. iyear_AD < 0 ) THEN
